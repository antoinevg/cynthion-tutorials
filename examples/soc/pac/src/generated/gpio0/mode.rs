...
impl R {
    ...
    #[doc = "Bits 1:2 - TODO amaranth_soc/csr/reg.py:471"]
    #[inline(always)]
    pub fn pin_1(&self) -> PIN_1_R {
        PIN_1_R::new(((self.bits >> 1) & 3) as u8)
    }
    #[doc = "Bits 2:3 - TODO amaranth_soc/csr/reg.py:471"]
    #[inline(always)]
    pub fn pin_2(&self) -> PIN_2_R {
        PIN_2_R::new(((self.bits >> 2) & 3) as u8)
    }
    #[doc = "Bits 3:4 - TODO amaranth_soc/csr/reg.py:471"]
    #[inline(always)]
    pub fn pin_3(&self) -> PIN_3_R {
        PIN_3_R::new(((self.bits >> 3) & 3) as u8)
    }
    #[doc = "Bits 4:5 - TODO amaranth_soc/csr/reg.py:471"]
    #[inline(always)]
    pub fn pin_4(&self) -> PIN_4_R {
        PIN_4_R::new(((self.bits >> 4) & 3) as u8)
    }
    #[doc = "Bits 5:6 - TODO amaranth_soc/csr/reg.py:471"]
    #[inline(always)]
    pub fn pin_5(&self) -> PIN_5_R {
        PIN_5_R::new(((self.bits >> 5) & 3) as u8)
    }
    #[doc = "Bits 6:7 - TODO amaranth_soc/csr/reg.py:471"]
    #[inline(always)]
    pub fn pin_6(&self) -> PIN_6_R {
        PIN_6_R::new(((self.bits >> 6) & 3) as u8)
    }
    #[doc = "Bits 7:8 - TODO amaranth_soc/csr/reg.py:471"]
    #[inline(always)]
    pub fn pin_7(&self) -> PIN_7_R {
        PIN_7_R::new(((self.bits >> 7) & 3) as u8)
    }
}
impl W {
    #[doc = "Bits 0:1 - TODO amaranth_soc/csr/reg.py:471"]
